  ...
  return (
    <div className="space-y-8">
      ...
      <StaffPanel
        ...
        description="One row per halqa, gender, and kind (Dawati or Tarbiyati). Add dated sessions in the next card."
      >
        <AttendanceProgramForm
          isAdmin={isAdmin}
      ...
      <StaffPanel
        title="Add a session"
        description="Choose program, session date, and start/end time (Asia/Bahrain). One session per program per calendar day."
      >
                ...
                <TableRow key={p.id}>
                  ...
                  <TableCell className="whitespace-nowrap text-xs">
                    {p.weekday != null && p.startTime && p.endTime ? (
                      ...
                      <span className="text-staff-on-surface-variant">Per session date</span>
                    )}
                  </TableCell>
